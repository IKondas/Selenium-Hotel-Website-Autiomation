...
# -------------------------- Data Setup --------------------------
buttons = [
("/html/body/div[2]/div/footer/div/div[1]/div[3]/ul/li[1]/a",   "/html/body/div[2]/div/section[1]"),
("/html/body/div[2]/div/footer/div/div[1]/div[3]/ul/li[2]/a",   "/html/body/div[2]/div/div/section[2]/div/div[1]/h2"),
("/html/body/div[2]/div/footer/div/div[1]/div[3]/ul/li[3]/a",   "/html/body/div[2]/div/div/section[1]/div/div/div/form/div/div[4]"),
("/html/body/div[2]/div/footer/div/div[1]/div[3]/ul/li[4]/a",   "/html/body/div[2]/div/section[3]/div/div/div/div/div/h3"), 
]
...
#None of the Quick Links have been set up, therefore a Fail is always expected here.
@pytest.mark.xfail
def test_group(buttons_fixture, subtests):
    with subtests.test("Open website"):
        mf.load_website()
    with subtests.test("Wait for button to load"):
        wait_for_button_to_load(buttons_fixture)
        mf.click_button(True, mf.load_element(buttons_fixture[0]))
